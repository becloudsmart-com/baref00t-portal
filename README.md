...
baref00t is a continuous Microsoft 365 + Azure security assessment platform with **32 products** across five families:
...
- **Security Packs (8)** — Entra ID Hardening, Email Security, SharePoint Oversharing, Endpoint/Intune, OAuth App & Consent-Grant Risk, plus industry packs (Finance, Legal, Healthcare)
...
- **Copilot Assessments** _— new in v2.4.0_ — Agent Inventory & Governance, Interaction Compliance, Meeting Insights Privacy & Coverage (triggerable today). Synthetic Red-Team Probe lists as Coming Soon (ships v2.4.1 alongside the delegated probe-user flow). Premium intelligence-tier audits against Microsoft's new [Copilot APIs](https://learn.microsoft.com/en-us/microsoft-365/copilot/extensibility/copilot-apis-overview); offered one-off ($799–$1,999 AUD today) or monthly ($99–$249).

MSPs operate under one of **3 partner plans** — Starter (10 runs/mo, assessments only), Professional (100 runs/mo, all 32 incl. Copilot Assessments), or Enterprise (unlimited, all 32).
...
- 🔁 **Recurring schedules** (`/schedules`) — Weekly/Monthly/Quarterly/Custom cadence per customer × product, pause/resume, run-now, and a quota forecast (projected runs vs plan limit) with an upgrade CTA
