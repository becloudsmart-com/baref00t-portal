...
Maintainers tag `portal-vX.Y.Z` upstream → the [portal-release workflow](.github/workflows/portal-release.yml) builds + pushes the image to GHCR and mirrors the source to this public repo + cuts a GitHub release here.
